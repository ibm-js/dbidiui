...
```bash
$ git clone git@github.com:username/dibi.git
```

This will clone your fork to your current path in a directory named `dibi`.
...
```bash
$ cd dibi
$ git remote add upstream git@github.com:ibm-dojo/dibi.git
$ git fetch upstream
```
